...
import backend.EquationBalancer;
import backend.History;
import backend.InvalidAtomException;
import backend.InvalidEquationException;
...
//        reactantsTextfield.addKeyListener(new KeyListener() {
//
//
//            @Override
...
//                int position = reactantsTextfield.getCaretPosition();
//                reactantsTextfield.setText(reactantsTextfield.getText().toUpperCase());
//                reactantsTextfield.setCaretPosition(position);
//            }
//        });
    ...
    private String formateEquation(String equation){
        String[] subScript = {"\u2080", "\u2081","\u2082","\u2083","\u2084","\u2085","\u2086","\u2087","\u2088","\u2089" };
    ...
    private void balanceButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (!reactants.isEmpty() || !products.isEmpty()) {
            ...
            try {
                balancedEquation = formateEquation(balancer.balance());
                errorMessagePanel.setVisible(false);
                givenEquationLabel.setText(formateEquation(reactants) + " = " + formateEquation(products));
